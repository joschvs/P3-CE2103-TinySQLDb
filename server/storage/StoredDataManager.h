...
private:
    ...
    // Serialización binaria de un registro (tamaño fijo, ver System Catalog
    // para contraste: ahí se usa longitud variable porque se carga todo a
    // memoria; aquí usamos tamaño fijo para poder hacer seek() por offset)
